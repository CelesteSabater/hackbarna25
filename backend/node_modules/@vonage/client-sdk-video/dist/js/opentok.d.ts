declare namespace OT {
  ...
  export type CpuPerformanceState = 'nominal' | 'fair' | 'serious' | 'critical';
  ...
  export class Session extends SessionOTEventEmitter<{
    ...
    cpuPerformanceChanged: Event<'cpuPerformanceChanged', Session> & {
      cpuPerformanceState: CpuPerformanceState;
    };
  ...
  export class Subscriber extends OTEventEmitter<{
    ...
    qualityScoreChanged: Event<'qualityScoreChanged', Subscriber> & {
    ...
    setStyle(styles: Partial<SubscriberStyle>): void;
